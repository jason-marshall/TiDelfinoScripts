...
#define	DI_H()		GPIO_WritePin(122,1)	/* Set MMC CS "high" */
#define DI_L()		GPIO_WritePin(122,0)	/* Set MMC CS "low" */
...
#define	CK_H()		GPIO_WritePin(123,1)	/* Set MMC CS "high" */
#define CK_L()		GPIO_WritePin(123,0)	/* Set MMC CS "low" */
...
#define	CS_H()		GPIO_WritePin(125,0)	/* Set MMC CS "high" */
#define CS_L()		GPIO_WritePin(125,0)	/* Set MMC CS "low" */
